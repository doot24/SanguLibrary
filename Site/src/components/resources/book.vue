  ...
  <div class="d-flex gap-4">
    ...
    <div class="d-flex gap-3 text-light">
      <div>
        ...
        <div class="p-2" style="background-color: rgba(61, 55, 71, 0.43);">ავტორი : <span>{{ formattedAuthors }}</span></div>
        <div class="p-2" style="background-color: #3B3748;"><span>რედაქტორი : {{ formattedEditors }}</span></div>
        <div class="p-2" style="background-color: rgba(61, 55, 71, 0.43);">განხილვა : <span>{{ resource?.description }}</span></div>
      ...
      <div>
        ...
        <div class="p-2" style="background-color: rgba(61, 55, 71, 0.43);"><span> ISBN : {{ resource?.isbn }}</span></div>
      </div>
    </div>
  </div>
</template>
